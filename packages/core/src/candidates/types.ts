...
export type AcceptanceDecision =
  ...
  | { readonly accepted: false; readonly reasonCode: string };

/** Candidate-level interpretation of one recorded task-body invocation. */
export type CandidateAttemptDecision =
  | CandidateActionDecision["disposition"]
  | "quality_rejected"
  | "accepted";
...
export type CandidateRunResult<C, T> =
