...
await suite.proof(
  ...
  "all declaration files are snapshotted, 0.6.0 compatibility is installed and checked, Node 20.11/22/24 are exercised, and two builds must pack identically",
  async () => {
